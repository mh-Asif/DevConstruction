...
(function () {
  ...
  // --------------------------------------------------------------------
    ...
    const polarChartVar = new Chart(polarChart, {
      type: 'polarArea',
      data: {
          labels: ['Open', 'In Progress', 'Compelete','Approved', 'Overdue',],
        datasets: [
          {
            label: 'Tasks',
            backgroundColor: [cyanColor, oceanBlueColor, orangeColor],
                data: [$('#OpenTPrc').val(), $('#InProgressTPrc').val(), $('#CompleteTPrc').val(), $('#ApprovedTPrc').val(), $('#OverdueTPrc').val()],
            borderWidth: 0
          }
        ]
      },
    ...
    if (doughnutChart) {
       ...
       // alert($('#OpenPrc').val());
        const doughnutChartVar = new Chart(doughnutChart, {
            type: 'doughnut',
            data: {
                labels: ['To Be Started', 'In Progress', 'Completed', 'Overdue', 'Approved'],
                datasets: [
                    {
                      /*  data: [OpenPrc, InProgressPrc, CompletePrc, OverduePrc, ApprovedPrc],*/
                      data: [$('#OpenPrc').val(), $('#InProgressPrc').val(), $('#CompletePrc').val(), $('#OverduePrc').val(), $('#ApprovedPrc').val()], // Updated percentages
                        backgroundColor: [
                            '#00bcd4', // Cyan for Open
                            '#007bff', // Blue for In Progress
                            '#28a745', // Green for Completed
                            '#ff9800', // Orange for Overdue
                            '#673ab7'  // Purple for Approved
                        ],
                        borderWidth: 0
                    }
                ]
  ...
  if (scatterChart) {
    ...
    const doughnutChartProject = document.getElementById('doughnutChartProject');
    if (doughnutChartProject) {

        //alert(doughnutChart);
        // alert($('#OpenPrc').val());
        const doughnutChartVar = new Chart(doughnutChartProject, {
            type: 'doughnut',
            data: {
                labels: ['Open', 'In Progress', 'Compelete', 'Approved', 'Overdue',],
                datasets: [

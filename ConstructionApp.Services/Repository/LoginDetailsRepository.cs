...
{
    public class LoginDetailsRepository : GenericRepository<LoginDetails>, ILoginDetailsRepository
    {
        public LoginDetailsRepository(ConstDbContext context) : base(context)
        {

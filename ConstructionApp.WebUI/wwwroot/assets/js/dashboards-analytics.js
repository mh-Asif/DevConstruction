...
(function () {
  ...
  if (typeof supportTrackerEl !== undefined && supportTrackerEl !== null) {
    ...
    // Support Tracker Dashboard - Radial Bar Chart
    // --------------------------------------------------------------------
    const supportDashboardTrackerEl = document.querySelector('#supportDashboardTracker'),
        supportDashboardTrackerOptions = {
            series: [$('#DashboardCompleted').val()],
            labels: ['Completed Task'],
            chart: {
                height: 360,
                type: 'radialBar'
    ...
    if (typeof supportDashboardTrackerEl !== undefined && supportDashboardTrackerEl !== null) {
        const supportDashboardTracker = new ApexCharts(supportDashboardTrackerEl, supportDashboardTrackerOptions);
        supportDashboardTracker.render();
    }

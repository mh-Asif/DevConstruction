...
(function () {
  ...
  // Defensive check for Menu.js usage
  ...
  layoutMenuEl.forEach(function (element) {
    if (typeof Menu !== 'undefined') {
      ...
      // Optionally log or handle the case where Menu is not available
      console.warn('Menu.js is not loaded; skipping menu initialization.');
    }
  });
